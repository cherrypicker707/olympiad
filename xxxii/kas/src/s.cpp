// Full Solution
// 100/100 points
// When submitting, '#include "../inc...' line should be replaced with '#include "kaslib.h"' as shown below.

#include <bits/stdc++.h>
#include "../inc/kaslib_original.h"
// #include "kaslib.h"
...
vfloat threshold = {4.19481f, 5.2753f, 6.66976f, 8.16094f, 8.96397f, 1.57211f, 2.91526f, -2.3258f, 4.54498f, 6.34585f, 3.39767f, 7.27444f, 6.60245f, 4.33596f, 14.0228f, -2.28109f, 20.9978f, 16.7641f, 29.0004f, 25.6924f, 17.3893f, 12.4909f, 41.4421f, 27.819f, 11.5218};
...
ll run()
{
    while(true)
    {
        ...
        for(ll i = 0; i < group_count; i++)
        {
            ...
            if(!check(discovered_part, i, false))
                break;

            discovered_part *= get_second_part(discovered_part, i);
            if(!check(discovered_part, i, true))
                break;
