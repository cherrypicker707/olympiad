...
ld binary_search(ld a, ld b, ld c, ld left, ld right);
...
int main()
{
    ...
    while(i < n - 1 && j < k)
    {
        ...
        ld t = binary_search(vertex[i].a, vertex[i].b - p, vertex[i].c, vertex[i].t, vertex[i + 1].t);
        j++;
